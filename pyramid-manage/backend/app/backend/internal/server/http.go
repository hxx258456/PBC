...
func NewHTTPServer(c *conf.Server, greeter *service.GreeterService, pyramid *service.PyramidService, logger log.Logger) *http.Server {
	...
	pb.RegisterPyramidHTTPServer(srv, pyramid)
	return srv
}
